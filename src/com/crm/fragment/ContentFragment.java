...
import com.crm.entity.TbUser;
import com.crm.local.LocalDao;
import com.crm.offline.LoginActivity;
import com.crm.offline.MainActivity;
import com.crm.offline.R;
...
public class ContentFragment extends BaseFragment {
	...
	public View initView() {
		...
		// 常用用户
		DbUtils db = DbUtils.create(mActivity, FileUtils.getExternalStoragePath() + DataBaseConstant.docLocation,
				DataBaseConstant.loginName);
		...
		final String loginNameArray[] = new String[userList.size()];
		...
		loginBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (passWord.equals("") || userFlag) {
					Toast.makeText(mActivity, "请选择用户或输入密码", Toast.LENGTH_SHORT).show();
				} else {
